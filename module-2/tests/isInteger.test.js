...
describe('isInteger', function () {
    ...
    describe('check report Errors if variable is NOT number', function () {
        const parameters = [
            ...
            { description: 'should return error if variable=undefined is not a number', input: undefined, result: 'Error: [undefined] is not a number' },
            { description: 'should return error if variable=NaN is not a number', input: NaN, result: 'Error: [NaN] is not a number' },
            { description: 'should return error if variable={name: "Stas", age: 35} is not a number', input: { name: 'Stas', age: 35 }, result: 'Error: [[object Object]] is not a number' },
            { description: 'should return error if variable=[1,2,3] is not a number', input: [1, 2, 3], result: 'Error: [1,2,3] is not a number' },
            { description: 'should return error if variable= ()=> false is not a number', input: () => false, result: 'Error: [() => false] is not a number' },
            { description: 'should return error if variable=1+"2" is not a number', input: 1 + '2', result: 'Error: [12] is not a number' },
            { description: 'should return error if variable="+" is not a number', input: '+', result: 'Error: [+] is not a number' },
            { description: 'should return error if variable=Symbol is not a number', input: Symbol, result: 'Error: [function Symbol() { [native code] }] is not a number' },
