...
describe('isAllNumbers', function () {
    ...
    describe('check report Errors if array is NOT array', function () {
        const parameters = [
            ...
            { description: 'should return error if array is {name: "Stas", age: 35}', input: { name: 'Stas', age: 35 }, result: 'Error: [[object Object]] is not an array' },
            ...
            { description: 'should return error if array is "+"', input: '+', result: 'Error: [+] is not an array' },
            { description: 'should return error if array is Symbol', input: Symbol, result: 'Error: [function Symbol() { [native code] }] is not an array' },
    ...
    describe('should return false if array has not only numbers', function () {
        const parameters = [
            ...
            { description: 'should return false if array has {name: "Stas", age: 35}', input: [{ name: 'Stas', age: 35 }, 17, 1, 55], result: false },
